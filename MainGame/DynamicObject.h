...
enum Actions { bottomHit = 0, upperHit = 1, directHit = 2, relax = 3, combatState = 4, move = 5, dead = 6, evasionDown = 7, evasionUp = 8,commonHit = 9, hardHit = 10, specialHit = 11, transitionToEnotherWorld = 12 };
